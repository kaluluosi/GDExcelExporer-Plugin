...
3:{ "id":3,  "int":2,  "float ":2.0,  "string":'',  "bool":True,  "array":[1, 2, 3],  "array_str":['b', 'c'],  "array_bool":[True],  "dict":{'name': 'Tom', 'age': 10},  "function":Callable(self,'function_3'),  "function_params":Callable(self,'function_params_3'),  "tr_string":'',  "tr_array_str":['b', 'c'],  "tr_dict":{'name': 'Tom', 'age': 10}, },
